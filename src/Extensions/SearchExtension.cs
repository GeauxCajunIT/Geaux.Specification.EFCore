...
using Geaux.Specification.EfCore.Expressions;
...
public static class SearchExtension
{
    ...
    public static IQueryable<T> Search<T>(this IQueryable<T> source, IEnumerable<SearchExpressionInfo<T>> criterias)
    {
        ...
        foreach (SearchExpressionInfo<T> criteria in criterias)
        {
            ...
            // Create a closure
            Expression searchTermAsExpression = ((Expression<Func<string>>)(() => criteria.SearchTerm)).Body;
